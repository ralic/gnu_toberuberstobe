/*
 * Game world realm tomato object type
...
game.realms.gameWorld.objectTypes.tomato = {
	...
	textureOf: function(object) {
		if (object.health > this.prototype.health / 2) {
			return game.textures.blocks_tomato;
		} else {
			return game.textures.blocks_damagedTomato;
		}
	},
	...
	New: function GameWorldObject(additions) {
		Object.assign(this,
			JSON.parse(JSON.stringify(
				game.realms.gameWorld.objectTypes.tomato.prototype
			)),

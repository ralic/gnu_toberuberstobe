/*
 * Game world realm rock object type
...
game.realms.gameWorld.objectTypes.rock = {
	...
	textureOf: function(object) {
		if (object.health > this.prototype.health / 2) {
			return game.textures.blocks_rock;
		} else {
			return game.textures.blocks_damagedRock;
		}
	},
	...
	New: function GameWorldObject(additions) {
		Object.assign(this,
			JSON.parse(JSON.stringify(
				game.realms.gameWorld.objectTypes.rock.prototype
			)),

/*
 * Game world realm stone object type
...
game.realms.gameWorld.objectTypes.stone = {
	...
	textureOf: function(object) {
		if (object.health > this.prototype.health / 2) {
			return game.textures.blocks_stone;
		} else {
			return game.textures.blocks_damagedStone;
		}
	},
	...
	New: function GameWorldObject(additions) {
		Object.assign(this,
			JSON.parse(JSON.stringify(
				game.realms.gameWorld.objectTypes.stone.prototype
			)),

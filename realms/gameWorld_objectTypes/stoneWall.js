/*
 * Game world realm stone wall object type
...
game.realms.gameWorld.objectTypes.stoneWall = {
	...
	textureOf: function(object) {
		if (object.health > this.prototype.health / 2) {
			return game.textures.blocks_stoneWall;
		} else {
			return game.textures.blocks_damagedStoneWall;
		}
	},
	...
	New: function GameWorldObject(additions) {
		Object.assign(this,
			JSON.parse(JSON.stringify(
				game.realms.gameWorld.objectTypes.stoneWall.prototype
			)),

/*
 * Game world realm dry grass object type
...
game.realms.gameWorld.objectTypes.dryGrass = {
	update: function(object, x, y) {
		if (object.health <= 0) {
			...
			game.realms.gameWorld.objectTypes[
				...
				[new game.realms.gameWorld.itemTypes.dryGrass.New()]
			);
		}
	},
	...
	textureOf: function(object) {
		if (object.health > this.prototype.health / 2) {
			return game.textures.blocks_dryGrass;
		} else {
			return game.textures.blocks_damagedDryGrass;
		}
	},
	...
	New: function GameWorldObject(additions) {
		Object.assign(this,
			JSON.parse(JSON.stringify(
				game.realms.gameWorld.objectTypes.dryGrass.prototype
			)),

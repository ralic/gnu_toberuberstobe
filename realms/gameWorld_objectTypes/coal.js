/*
 * Game world realm coal object type
...
game.realms.gameWorld.objectTypes.coal = {
	update: function(object, x, y) {
		if (object.health <= 0) {
			...
			game.realms.gameWorld.objectTypes[
				...
				[
					new game.realms.gameWorld.itemTypes.coal.New(),
					new game.realms.gameWorld.itemTypes.coal.New()
				]
			);
		}
	...
	textureOf: function(object) {
		if (object.health > this.prototype.health / 2) {
			return game.textures.blocks_coal;
		} else {
			return game.textures.blocks_damagedCoal;
		}
	},
	...
	New: function GameWorldObject(additions) {
		Object.assign(this,
			JSON.parse(JSON.stringify(
				game.realms.gameWorld.objectTypes.coal.prototype
			)),

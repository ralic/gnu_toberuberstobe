/*
 * Game world realm haloxylon object type
...
game.realms.gameWorld.objectTypes.haloxylon = {
	...
	textureOf: function(object) {
		if (object.health > this.prototype.health / 2) {
			return game.textures.blocks_haloxylon;
		} else {
			return game.textures.blocks_damagedHaloxylon;
		}
	},
	...
	New: function GameWorldObject(additions) {
		Object.assign(this,
			JSON.parse(JSON.stringify(
				game.realms.gameWorld.objectTypes.haloxylon.prototype
			)),

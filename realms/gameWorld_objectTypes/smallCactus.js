/*
 * Game world realm small cactus object type
...
game.realms.gameWorld.objectTypes.smallCactus = {
	...
	textureOf: function(object) {
		if (object.health > this.prototype.health / 2) {
			return game.textures.blocks_smallCactus;
		} else {
			return game.textures.blocks_damagedSmallCactus;
		}
	},
	...
	New: function GameWorldObject(additions) {
		Object.assign(this,
			JSON.parse(JSON.stringify(
				game.realms.gameWorld.objectTypes.smallCactus.prototype
			)),
